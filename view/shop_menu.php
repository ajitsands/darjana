...
<head>
	...
	<!-- CANONICAL URL -->
	<link rel="canonical" href="https://pixio.dexignzone.com/xhtml/about-me.html">
						...
						<li class="has-mega-menu sub-menu-down auto-width">
								...
								<div class="mega-menu">
									<ul>
										...
										<li>
											<a href="javascript:void(0);" class="menu-title">Blog List Sidebar</a>
											<ul>
												<li><a href="blog-list-no-sidebar.html">No Sidebar <div class="badge badge-sm rounded badge-animated">New</div></a></li>
												<li><a href="blog-list-left-sidebar.html">left Sidebar <div class="badge badge-sm rounded badge-animated">New</div></a></li>
												<li><a href="blog-list-right-sidebar.html">Right Sidebar <div class="badge badge-sm rounded badge-animated">New</div></a></li>
												<li><a href="blog-list-both-sidebar.html">Both Sidebar <div class="badge badge-sm rounded badge-animated">New</div></a></li>
											</ul>
											<a href="javascript:void(0);" class="menu-title">Blog Grid Sidebar</a>
											<ul>
												<li><a href="blog-grid-no-sidebar.html">No Sidebar <div class="badge badge-sm rounded badge-animated">New</div></a></li>
												<li><a href="blog-grid-left-sidebar.html">left Sidebar <div class="badge badge-sm rounded badge-animated">New</div></a></li>
												<li><a href="blog-grid-right-sidebar.html">Right Sidebar <div class="badge badge-sm rounded badge-animated">New</div></a></li>
												<li><a href="blog-grid-both-sidebar.html">Both Sidebar <div class="badge badge-sm rounded badge-animated">New</div></a></li>
												<li><a href="blog-grid-wide-sidebar.html">Wide Sidebar <div class="badge badge-sm rounded badge-animated">New</div></a></li>
											</ul>
										</li>
										<li>
							...
							<div class="mega-menu">
								<ul>
									<li>
										...
										<ul>
												<li><a href="post-text.html">Text Post <div class="badge badge-sm rounded badge-animated">New</div></a></li>
											<li><a href="post-image.html">Image Post <div class="badge badge-sm rounded badge-animated">New</div></a></li>
											...
											<li><a href="post-tutorial.html">Tutorial Post <div class="badge badge-sm rounded badge-animated">New</div></a></li>
											<li><a href="post-cateloge.html">Cateloge Post <div class="badge badge-sm rounded badge-animated">New</div></a></li>
										</ul>
									</li>
									<li>
										...
										<ul>	
											...
											<li><a href="post-status.html">Status Slider <div class="badge badge-sm rounded badge-animated">New</div></a></li>
										</ul>
										...
										<ul>	
											...
											<li><a href="post-side.html">Side Post <div class="badge badge-sm rounded badge-animated">New</div></a></li>
										</ul>
									</li>
									<li>
						...
						<div class="row g-xl-4 g-md-4 g-3">
							<div class="col-xl-8 col-lg-8 col-sm-8 col-8 wow fadeInUp" data-wow-delay="0.4s">
								<div class="about-thumb">
									<img src="images/about/pic4.jpg" alt="" class="rounded">
								</div>
							</div>
							<div class="col-xl-4 col-lg-4 col-sm-4 col-4 wow fadeInUp" data-wow-delay="0.5s">
								<div class="about-thumb">
									<img src="images/about/pic5.jpg" alt="" class="rounded">
								</div>
							</div>
							<div class="col-lg-12 wow fadeInUp" data-wow-delay="0.6s">
								<div class="about-thumb">
									<img src="images/about/pic6.jpg" alt="" class="rounded"> 
								</div>
							</div>
							<div class="col-lg-12 wow fadeInUp" data-wow-delay="0.7s">
								<div class="about-thumb">
									<img src="images/about/pic7.jpg" alt="" class="rounded">
								</div>
							</div>
						</div>
					</div>		
