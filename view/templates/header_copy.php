            ...
            <div class="container-fluid clearfix d-lg-flex d-block">
                ...
                <div class="header-nav w3menu navbar-collapse collapse justify-content-start" id="navbarNavDropdown">
                    ...
                    <ul class="nav mobile-extra-icons d-lg-none mt-1 pt-1 pb-1 border-top">
                        ...
                        <!-- Language -->
                        <li class="nav-item">
                            <button id="mobileLanguageSwitcher" class="nav-link px-3" style="font-size:1.1rem; font-weight:bold;">
                ...
                <div class="extra-nav">
                    <div class="extra-cell" style="display: flex; justify-content: flex-end; flex-wrap: wrap;">
                        <ul class="header-right"
                            style="display: flex; align-items: center; margin: 0; padding: 0; list-style: none; flex-wrap: wrap; ">
                            <!-- Replace the existing <li class="nav-item currency-dropdown"> ... </li> gap: 10px; block with this -->

                            <li class="nav-item currency-dropdown" style="flex: 0 0 auto; position: relative;">
                                <button id="currencySwitcher" class="nav-link" 
                                        style="background: none; border: 1px solid #ddd; border-radius: 4px; padding: 6px 10px; cursor: pointer; font-weight: bold; display: flex; align-items: center; gap: 6px;">
                                    <span id="dropDownFlagIcon">
                                        <?php 
                                            echo isset($_SESSION['currency']['flag_emoji']) ? $_SESSION['currency']['flag_emoji'] : '<span class="fi fi-bh"></span>';
                                        ?>
                                    </span>
                                    <span id="currentCurrencyCode">
                                        <?php 
                                            echo isset($_SESSION['currency']['currency_code']) ? $_SESSION['currency']['currency_code'] : 'BHD';
                                        ?>
                                    </span>
                                ...
                                <div id="currencyDropdown" class="currency-dropdown-menu" 
                                     style="display: none; background: white; border: 1px solid #ddd; border-radius: 8px; box-shadow: 0 6px 20px rgba(0,0,0,0.18); z-index: 1050; min-width: 240px; max-width: 90vw; overflow: hidden;">
                            ...
                            <li class="nav-item wishlist-link" style="flex: 0 0 auto;">
                                <a class="nav-link" href="javascript:void(0);" data-bs-toggle="offcanvas"
                                    ...
                                    style="text-decoration: none; padding: 5px 10px; position: relative;">
                                    <i class="iconly-Light-Heart2"></i>
                                    <span class="badge badge-circle" id="wishlist-badge-count"
                                        style="position: absolute; top: 0; right: 0; background: red; color: white; border-radius: 50%; font-size: 10px; padding: 2px 5px; display: none;">0</span>
                                </a>
                            </li>
                            ...
                            <li class="nav-item cart-link" style="flex: 0 0 auto;">
                                <a href="javascript:void(0);" class="nav-link cart-btn" data-bs-toggle="offcanvas"
                                    ...
                                    <span class="badge badge-circle" id="cart-badge-count"
                                        style="position: absolute; top: 0; right: 0; background: red; color: white; border-radius: 50%; font-size: 10px; padding: 2px 5px; display: none;">0</span>
                                </a>
                            </li>

                            <li class="nav-item language-link" style="flex: 0 0 auto;">
                                <button id="languageSwitcher" class="nav-link" 
                                        style="background: none; border: 1px solid #ddd; border-radius: 4px; padding: 5px 10px; cursor: pointer; font-weight: bold;">
                                    <span id="currentLanguage"><?= $lang === 'arabic' ? 'AR' : 'EN' ?></span> / 
                                    <span id="targetLanguage"><?= $lang === 'arabic' ? 'EN' : 'AR' ?></span>
                                </button>
                            </li>
                            ...
                            <?php if (isset($_SESSION['ids']) && $_SESSION['ids'] > 0): ?>
                               ...
                               <li class="has-mega-menu sub-menu-down">
                                    <a href="Orders" style="font-weight: bold;">

                                       <i class="fa fa-clipboard-list"></i>
                                    </a>
                                </li>
                                <li class="has-mega-menu sub-menu-down">
                                    <a href="Profile" style="font-weight: bold;">
