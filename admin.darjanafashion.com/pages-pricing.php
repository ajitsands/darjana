...
<html
  ...
  <head>
    ...
    <title>WhatsAppAPI | Pricing</title>
                      ...
                      <div class="col-lg mb-lg-0 mb-3">
                        <div class="card border shadow-none">
                          <div class="card-body pt-12">
                            ...
                            <a href="auth-register-basic.html" class="btn btn-outline-success d-grid w-100"
                              >Your Current Plan</a
                            >
                          </div>
                        </div>
                      ...
                      <div class="col-lg">
                        <div class="card border shadow-none">
                          <div class="card-body pt-12">
                            ...
                            <a href="auth-register-basic.html" class="btn btn-outline-primary d-grid w-100">Upgrade</a>
                          </div>
                        </div>
                      </div>
                    </div>
